...
<form id="form1" name="form1" method="post" action="">
  <table width="1000" height="221" border="1">
    <tr>
    ...
    <?php
	include("connect.php");
	$str="select producttable. P_ID,producttable. P_Name,producttable.P_Quantity,producttable.Price,producttable.ProductBrand,stocktable.Stk_qty from producttable,stocktable where producttable.P_ID=stocktable.P_ID and stocktable.Stk_qty<5";
	$res=mysql_query($str);
	$i=1;
    ...
    <tr>
      ...
      <td><div align="center"><p align="center"><a href="AddStock.php?id=<?php echo $res1[0] ?>">Add Quantity</a></p></div>
      </td>
    </tr>
	<?php $i++; }?>
